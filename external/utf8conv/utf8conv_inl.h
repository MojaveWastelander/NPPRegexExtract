...
inline std::wstring UTF16FromUTF8(const std::string & utf8)
{
    ...
    //
    const size_t utf16Length = ::MultiByteToWideChar(
...
inline std::wstring UTF16FromUTF8(const char * utf8, size_t uBufferSize)
{
    //
    // Special case of empty input string
    //
    ...
    const size_t utf8Length = (uBufferSize != 0)?uBufferSize:static_cast<int>(strlen(utf8));
...
inline std::string UTF8FromUTF16(const std::wstring & utf16)
{
    ...
    //
    const size_t utf8Length = ::WideCharToMultiByte(
...
inline std::string UTF8FromUTF16(const wchar_t * utf16)
{
    ...
    const size_t utf16Length = static_cast<int>(wcslen(utf16));
